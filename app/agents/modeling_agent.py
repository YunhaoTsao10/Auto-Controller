...
def modeling_agent(state: dict) -> dict:
    ...
    system = (
        ...
        "- If the controller family is PID/PI/PD/P and the system can be approximated as SISO second-order linear, include canonical coefficients a1, a0, b0 in model.parameters for G(s)=b0/(s^2+a1*s+a0).\n"
